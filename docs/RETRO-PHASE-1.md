...
| A7 | E2E 4 條 happy path（list / search / category drawer / a11y full scan）補完 | qa agent | **deferred — 時間限制未完成**。工具鍊已 wire（playwright.config + smoke spec + e2e.yml workflow），手動 QA 走 docs/DEMO.md 步驟，補完估 1-2h |
